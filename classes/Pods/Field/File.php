	...
	public function options() {
		...
		$options = array(
			...
			self::$type . '_uploader'           => array(
				...
				'default'    => 'attachment',
				'type'       => 'pick',
				'data'       => apply_filters( 'pods_form_ui_field_file_uploader_options',
					array(
			...
			self::$type . '_type'               => array(
				...
				'type'       => 'pick',
				'data'       => apply_filters( 'pods_form_ui_field_file_type_options',
					array(
			...
			<ul class="pods-file-meta media-item">
				...
				if ( $linked ) {
					...
					<li class="pods-file-col pods-file-download">
						<a href="<?php echo esc_url( $link ); ?>" target="_blank"><?php _e( 'Download' ); ?></a></li>
				<?php
				}
				?>
			</ul>
