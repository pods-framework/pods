...
?>
		<div class="pods-admin_friends-callout_container">
			...
			<div class="pods-admin_friends-callout_content-container">
				<h2 class="pods-admin_friends-callout_headline"><?php printf( esc_html__( 'We need %1$sYOU%2$s in 2021 and beyond', 'pods' ), '<span class="pods-admin_friends-you">', '</span>' ); ?></h2>
				<p class="pods-admin_friends-callout_text"><?php esc_html_e( 'We are aiming to grow Pods and we want you to be a part of it! Our goal is to be fully funded by people who use our plugin. Help us reach our goal of 200 recurring donors in 2021.', 'pods' ); ?></p>
				<p class="pods-admin_friends-callout_text"><?php
					// translators: %s: Pods Pro by SKCDEV.
					printf(
						esc_html__( 'You can also check out the new %s which has partnered with Friends of Pods to bring in more donations.', 'pods' ),
