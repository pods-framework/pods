	...
	public function setup_updated_messages( $messages ) {
		...
		foreach ( $post_types as $post_type ) {
			...
			$messages[ $post_type['name'] ] = array(
				...
				8  => sprintf( __( '%s submitted. <a target="_blank" href="%s">Preview %s</a>', 'pods' ), $labels['singular_name'], esc_url( get_preview_post_link( $post_ID ) ), $labels['singular_name'] ),
				...
				10 => sprintf( __( '%s draft updated. <a target="_blank" href="%s">Preview %s</a>', 'pods' ), $labels['singular_name'], esc_url( get_preview_post_link( $post_ID ) ), $labels['singular_name'] )
			);
