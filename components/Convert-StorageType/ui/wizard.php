<div class="wrap pods-admin">
    ...
    <form action="" method="post" class="pods-submittable">
        <div class="pods-submittable-fields">
            <input type="hidden" name="action" value="pods_admin_components" /> <input type="hidden" name="component" value="<?php echo $component; ?>" /> <input type="hidden" name="method" value="<?php echo $method; ?>" /> <input type="hidden" name="_wpnonce" value="<?php echo wp_create_nonce( 'pods-component-' . $component . '-' . $method ); ?>" /> <input type="hidden" name="cleanup" id="pods_cleanup" value="0" />

            <h2 class="italicized"><?php _e( 'Convert: Change Storage Type of Pod', 'pods' ); ?></h2>

            <img src="<?php echo PODS_URL; ?>/ui/images/pods-logo-notext-rgb-transparent.png" class="pods-leaf-watermark-right" />

            <div id="pods-wizard-box" class="pods-wizard-steps-3 pods-wizard-hide-first">
                <!-- Steps headings, top -->
                <div id="pods-wizard-heading">
                    <ul>
                        ...
                        <li data-step="2">
                            <i></i> <span>2</span> <?php _e( 'Choose Pod(s)', 'pods' ); ?>
                            <em></em>
                        </li>
                        <li data-step="3">
                            <i></i> <span>3</span> <?php _e( 'Convert', 'pods' ); ?>
                            <em></em>
                        </li>
                    </ul>
                </div>
                ...
                <div id="pods-wizard-main">
                    ...
                    <div id="pods-wizard-panel-1" class="pods-wizard-panel">
                        <div class="pods-wizard-content">
                            <p><?php _e( 'Choose which storage type you would like to convert', 'pods' ); ?></p>
                        </div>

                        <div id="pods-wizard-options">
                            <div class="pods-wizard-option">
                                <a href="#pods-wizard-import" data-opt="0">
                                    <h2><?php _e( 'Table to Meta Conversion', 'pods' ); ?></h2>

                                    <p><?php _e( 'This will allow you to convert one or more Pods from table to meta based storage.', 'pods' ); ?></p>
                                </a>
                            ...
                            <div class="pods-wizard-option">
                                <a href="#pods-wizard-import-clean" data-opt="1">
                                    <h2><?php _e( 'Meta to Table Conversion', 'pods' ); ?></h2>

                                    <p><?php _e( 'This will allow you to convert one or more Pods from meta to table based storage.', 'pods' ); ?></p>
                                </a>
