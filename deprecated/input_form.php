...
<script type="text/javascript" src="<?php echo PODS_URL; ?>/deprecated/js/jqmodal.js"></script>
...
<div class="pods_form form_<?php echo $this->pod; ?> form_<?php echo $form_count; ?>">
<?php
if (1 == $form_count)
{
?>
...
$this->showform($this->get_field('id'), $public_columns, $label);
?>
</div>
<?php 
//post-form hooks
