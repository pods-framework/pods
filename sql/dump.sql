...
CREATE TABLE IF NOT EXISTS wp_tbl_country (
    id INT unsigned auto_increment primary key,
    name VARCHAR(64)
);

CREATE TABLE IF NOT EXISTS wp_tbl_state (
    id INT unsigned auto_increment primary key,
    name VARCHAR(64)
);

CREATE TABLE IF NOT EXISTS wp_tbl_person (
    id INT unsigned auto_increment primary key,
    name VARCHAR(128),
    body TEXT,
    photo VARCHAR(128),
...
CREATE TABLE IF NOT EXISTS wp_tbl_event (
    id INT unsigned auto_increment primary key,
    name VARCHAR(128),
    body TEXT,
    start_date DATETIME,
