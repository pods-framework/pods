	...
	public function get_fields( \Pods\Whatsit\Pod $pod, array $tabs ) {
		...
		if ( 'settings' !== $pod_type && ! $is_extended ) {
			$labels = [
				...
				'label_add_new'                    => [
					'label'               => __( 'Add New %s (page title link text)', 'pods' ),
					'label_param'         => 'label_singular',
					'label_param_default' => __( 'Item', 'pods' ),
					'help'                => __( 'This is the text used for page titles. This "add_new" text used to be separate from the newer "add_new_item" but as of WordPress 6.4 they are following the same default context instead of just "Add New" as the text.', 'pods' ),
					'type'                => 'text',
					'default'             => '',
				...
				'label_add_new_item'               => [
					...
					'label_param'         => 'label_singular',
					'label_param_default' => __( 'Item', 'pods' ),
					'help'                => __( 'This is the text used for new item links.', 'pods' ),
					'type'                => 'text',
					'default'             => '',
				],
				'label_new_item'                   => [
