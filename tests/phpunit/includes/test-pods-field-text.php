...
class Test_PodsField_Text extends Pods_UnitTestCase {
	...
	public function test_method_strip_html_default_options() {
		...
		$this->assertEquals( 'foo', $this->field->strip_html( '<strong><em><a href="#"><ul><li><ol><li><b><i>foo</i></b></li></ol></li></ul></a></em></strong>' ), $this->field->options() );
	}
	...
	public function test_method_strip_html_default_tags_allowed() {
		...
		$this->assertEquals( '<strong><em><a href="#"><ul><li><ol><li><b><i>foo</i></b></li></ol></li></ul></a></em></strong>', $this->field->strip_html( '<strong><em><a href="#"><ul><li><ol><li><b><i>foo</i></b></li></ol></li></ul></a></em></strong>', $options ) );
	}
	...
	public function test_method_strip_html_br_tags_allowed() {
		...
		$this->assertEquals( 'foo<br />', $this->field->strip_html( 'foo<br />', $options ) );
	}
	...
	public function test_method_strip_html_hr_tags_allowed() {
		...
		$this->assertEquals( 'foo<hr />', $this->field->strip_html( 'foo<hr />', $options ) );
	}
	...
	public function test_method_strip_html_tags_allowed() {
		...
		$this->assertEquals( '<strong><em>foo</em></strong>', $this->field->strip_html( '<div><strong><em>foo</em></strong></div>', $options ) );
	}
}
