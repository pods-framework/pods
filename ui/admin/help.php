<div class="wrap pods-admin">
    ...
    <p>
        This plugin is an <strong>alpha</strong> version, it is not meant for use on production/live sites and is not 100% complete with functionality yet.
        This plugin has been released early to developers so they can help test, review the new UI, and provide feedback regarding Pods 2.0
    </p>
