							...
							<table class="widefat fixed pages" cellspacing="0">
								...
								<tr>
									...
									<th scope="col" id="label" class="manage-column field-label">
										<span>
										<?php
										esc_html_e( 'Label', 'pods' );
											pods_help( '<h6>' . __( 'Label', 'pods' ) . '</h6>' . __( 'The label is the descriptive name to identify the Pod field.', 'pods' ) );
											?>
											</span>
									</th>
									<th scope="col" id="machine-name" class="manage-column field-machine-name">
										<span>
										<?php
										esc_html_e( 'Name', 'pods' );
											pods_help( '<h6>' . __( 'Name', 'pods' ) . '</h6>' . __( 'The name attribute is what is used to identify and access the Pod field programatically.', 'pods' ) );
											?>
											</span>
									</th>
									<th scope="col" id="field-type" class="manage-column field-field-type">
										<span>
										<?php
										esc_html_e( 'Field Type', 'pods' );
											pods_help( '<h6>' . __( 'Field Type', 'pods' ) . '</h6>' . __( 'Field types are used to determine what kind of data will be stored in the Pod. They can range from, dates, text, files, etc.', 'pods' ) );
											?>
											</span>
									</th>
								</tr>
							...
							if ( 'post_type' === $pod_type && strlen( pods_v( 'object', $pod ) ) < 1 ) {
										...
										<ul>
											...
											<li>
												<div class="pods-field pods-boolean">
													<?php
													echo PodsForm::field(
														'supports_thumbnail', pods_v( 'supports_thumbnail', $pod, false ), 'boolean', array(
								...
								<div class="pods-field-option">
									<?php echo PodsForm::label( 'hierarchical', __( 'Hierarchical', 'pods' ), __( 'help', 'pods' ) ); ?>
												<?php
												echo PodsForm::field(
													'hierarchical', (int) pods_v( 'hierarchical', $pod, 0 ), 'boolean', array(
														'dependency'        => true,
														'boolean_yes_label' => '',
													)
												);
