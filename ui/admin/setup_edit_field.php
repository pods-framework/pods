                            ...
                            <div class="pods-tab-group">
                                <div id="pods-basic-options-<?php echo $pods_i; ?>" class="pods-tab pods-basic-options">
                                    <div class="pods-field-option">
                                        ...
                                        <?php echo PodsForm::field('field_data[' . $pods_i . '][name]', pods_var('name', $field), 'db'); ?>
                                    </div>
                                    <div class="pods-field-option">
                                        <?php echo PodsForm::label('field_data[' . $pods_i . '][label]', __('Label', 'pods'), __('help', 'pods')); ?>
                                        <?php echo PodsForm::field('field_data[' . $pods_i . '][label]', pods_var('label', $field), 'text'); ?>
                                    </div>
                                    <div class="pods-field-option">
                                        <?php echo PodsForm::label('field_data[' . $pods_i . '][description]', __('Description', 'pods'), __('help', 'pods')); ?>
                                        <?php echo PodsForm::field('field_data[' . $pods_i . '][description]', pods_var('description', $field), 'text'); ?>
                                    </div>
                                    <div class="pods-field-option">
                                    ...
                                    <div class="pods-field-option-container pods-depends-on pods-depends-on-field-data-type pods-depends-on-field-data-type-pick">
                                        <div class="pods-field-option">
                                            ...
                                            <?php echo PodsForm::field('field_data[' . $pods_i . '][pick_object]', trim( pods_var('pick_object', $field) . '-' . pods_var( 'pick_val', $field ), '-' ), 'pick', array('data' => pods_var('pick_object', $field_settings), 'class' => 'pods-dependent-toggle')); ?>
                                        </div>
                                        <div class="pods-field-option pods-depends-on pods-depends-on-field-data-pick-object pods-depends-on-field-data-pick-object-custom-simple">
                                            ...
                                            <?php echo PodsForm::field('field_data[' . $pods_i . '][pick_custom]', pods_var('pick_custom', $field), 'paragraph'); ?>
                                        </div>
                                        <div class="pods-field-option pods-depends-on pods-depends-on-field-data-pick-object pods-depends-on-field-data-pick-object-pod-event">
                                            ...
                                            <?php echo PodsForm::field('field_data[' . $pods_i . '][sister_field_id]', pods_var('sister_field_id', $field), 'pick', array('data' => pods_var('sister_field_id', $field_settings))); ?>
                                        </div>
                                    </div>
