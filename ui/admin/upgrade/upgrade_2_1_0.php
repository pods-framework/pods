	...
	<div id="pods-wizard-box" class="pods-wizard-steps-3" data-action="pods_admin" data-method="upgrade" data-_wpnonce="<?php echo esc_attr( wp_create_nonce( 'pods-upgrade' ) ); ?>" data-version="<?php echo esc_attr( $new_version ); ?>">
		<div id="pods-wizard-heading">
			<ul>
				...
				<li data-step="3">
					<i></i> <span>3</span> <?php esc_html_e( 'Upgrade', 'pods' ); ?> <em></em>
				</li>
			</ul>
		</div>
		<div id="pods-wizard-main">
			...
			<div id="pods-wizard-panel-2" class="pods-wizard-panel">
				<div class="pods-wizard-content">
					<p><?php esc_html_e( 'We will prepare your relationships for the upgrade. If any issues are found they will be displayed below for your review. Be sure to backup your database before continuing onto the next step for the Upgrade.', 'pods' ); ?></p>
				</div>
				<table cellpadding="0" cellspacing="0">
					...
					<thead>
					<tr>
						<th colspan="3"><?php esc_html_e( 'Preparing Your Relationships for Upgrade', 'pods' ); ?>..</th>
					</tr>
					</thead>
					<tbody>
			...
			<div id="pods-wizard-panel-3" class="pods-wizard-panel">
				<div class="pods-wizard-content">
					<p><?php esc_html_e( 'During this process your Relationships will be optimized.', 'pods' ); ?></p>
				</div>
				<table cellpadding="0" cellspacing="0">
					<col style="width: 70px">
					<col style="width: 110px">
					...
					<thead>
					<tr>
						<th colspan="3"><?php esc_html_e( 'Optimizing Your Relationships', 'pods' ); ?>..</th>
					</tr>
					</thead>
		...
		<div id="pods-wizard-actions">
			...
			<div id="pods-wizard-finished">
				<?php esc_html_e( 'Upgrade Complete!', 'pods' ); ?>
			</div>
		</div>
	</div>
</div>
