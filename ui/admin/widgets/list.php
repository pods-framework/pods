	...
	<?php if ( 0 < count( $all_pods ) ): ?>
		<select id="<?php echo $this->get_field_id( 'pod_type' ); ?>" name="<?php echo $this->get_field_name( 'pod_type' ); ?>">
			<?php foreach ( $all_pods as $pod_name => $pod_label ): ?>
				<option value="<?php echo $pod_name; ?>"<?php selected( $pod_name, $pod_type ); ?>>
	...
	<li>
		...
		<select name="<?php echo $this->get_field_name( 'template' ); ?>" id="<?php echo $this->get_field_id( 'template' ); ?>">
			...
			<?php foreach ( $all_templates as $tpl ): ?>
				<option value="<?php echo $tpl['name']; ?>"<?php selected( $tpl['name'], $template ); ?>>
...
<li>
	...
	<select id="<?php echo $this->get_field_id( 'cache_mode' ); ?>" name="<?php echo $this->get_field_name( 'cache_mode' ); ?>">
		<?php foreach ( $cache_modes as $cache_mode_value => $cache_mode_label ): ?>
			<option value="<?php echo $cache_mode_value; ?>"<?php selected( $cache_mode_value, $cache_mode ); ?>>
...
<li>
	<label for="<?php echo $this->get_field_id( 'expires' ); ?>"><?php _e( 'Cache Expiration (in seconds)', 'pods' ); ?></label>
