...
<script>
    ...
    jQuery( function ( $ ) {
        ...
        if ( 'undefined' == typeof codemirror_<?php echo esc_js( pods_clean_name( $attributes[ 'id' ] ) ); ?> ) {
            ...
            codemirror_<?php echo esc_js( pods_clean_name( $attributes[ 'id' ] ) ); ?>.on( 'blur', function() {
                var value = codemirror_<?php echo esc_js( pods_clean_name( $attributes[ 'id' ] ) ); ?>.getValue();
                $textarea_<?php echo esc_js( pods_clean_name( $attributes[ 'id' ] ) ); ?>.val( value );
            });
