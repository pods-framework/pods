<span class="pods-pagination-advanced">
    ...
    if ( 1 < $params->page ) {
        ...
        <?php if ( $params->first_last ) { ?>
            <a href="<?php echo pods_var_update( array( $params->page_var => 1 ) ); ?>" class="pods-pagination-number pods-pagination-first"><?php echo $params->first_text; ?></a>
            <?php } ?>
        <?php if ( $params->prev_next ) { ?>
            <a href="<?php echo pods_var_update( array( $params->page_var => ( $params->page - 1 ) ) ); ?>" class="pods-pagination-number pods-pagination-prev"><?php echo $params->prev_text; ?></a>
            <?php } ?>
    ...
    if ( $params->page < $params->total ) {
        ?>
        <a href="<?php echo pods_var_update( array( $params->page_var => $params->total ) ); ?>" class="pods-pagination-number pods-pagination-last"><?php echo $params->total; ?></a>
        <?php
        if ($params->prev_next ) {
            ?>
