...
export const uiConstants = {
	actions: {
		...
		SET_GROUP_SAVE_STATUS: 'SET_GROUP_SAVE_STATUS',
		SET_GROUP_DELETE_STATUS: 'SET_GROUP_DELETE_STATUS',

		SET_FIELD_SAVE_STATUS: 'SET_FIELD_SAVE_STATUS',
		SET_FIELD_DELETE_STATUS: 'SET_FIELD_DELETE_STATUS',
	},
