...
// Helper components
const Spinner = () => <img src="/wp-admin/images/wpspin_light.gif" alt="" />;
	...
	useEffect( () => {
		...
		if ( deleteStatus === DELETE_STATUSES.DELETE_SUCCESS ) {
			window.location.replace(
				'/wp-admin/admin.php?page=pods&deleted=1'
			);
		}
										...
										<button
											onClick={ () => {
												const confirm = window.confirm(
													__(
														'Are you sure you want to delete this Pod? All fields and data will be removed.',
														'pods'
													)
												);
