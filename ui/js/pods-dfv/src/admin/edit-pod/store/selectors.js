...
export const getTabList = ( state ) => paths.TAB_LIST.getFrom( state );
...
export const getTabOptions = ( state, tabName ) => {
	return getTabOptionsList( state, tabName ).map( ( optionName ) =>
...
export const getDeleteStatus = ( state ) =>
	paths.DELETE_STATUS.getFrom( state );
...
//-- Groups
export const getGroupList = ( state ) => paths.GROUP_LIST.getFrom( state );
...
export const getGroups = ( state ) => state.groups.currentPod.groups;
