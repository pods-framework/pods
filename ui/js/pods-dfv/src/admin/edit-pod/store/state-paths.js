...
const createTree = ( value, dotPath ) => {
	return dotPath.split( '.' ).reduceRight( ( acc, currentValue ) => {
...
export const GROUP_FIELD_LIST = createStatePath(
	`${ GROUPS.path }.groupFieldList`
);
...
export const TAB_OPTIONS_LIST = createStatePath(
	`${ TABS.path }.tabOptionsList`
);
