<?php
/**
   * Pods__Prefixed__Spyc -- A Simple PHP YAML Class
   * @version 0.6.2
...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return Pods__Prefixed__Spyc::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_load_file')) {
  ...
  function spyc_load_file ($file) {
    return Pods__Prefixed__Spyc::YAMLLoad($file);
  }
}
...
if (!function_exists('spyc_dump')) {
  ...
  function spyc_dump ($data) {
    return Pods__Prefixed__Spyc::YAMLDump($data, false, false, true);
  }
}

if (!class_exists('Pods__Prefixed__Spyc')) {
...
/**
   ...
   * Usage:
   * <code>
   *   $Spyc  = new Pods__Prefixed__Spyc;
   *   $array = $Spyc->load($file);
   * </code>
   * or:
   * <code>
   *   $array = Pods__Prefixed__Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
...
/**
 * Load a valid YAML string to Pods__Prefixed__Spyc.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to Pods__Prefixed__Spyc.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Pods__Prefixed__Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Pods__Prefixed__Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
...
// Enable use of Pods__Prefixed__Spyc from command line
// The syntax is the following: php Pods__Prefixed__Spyc.php spyc.yaml

do {
  if (PHP_SAPI != 'cli') break;
  if (empty ($_SERVER['argc']) || $_SERVER['argc'] < 2) break;
  if (empty ($_SERVER['PHP_SELF']) || FALSE === strpos ($_SERVER['PHP_SELF'], 'Pods__Prefixed__Spyc.php') ) break;
  $file = $argv[1];
